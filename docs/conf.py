# -*- coding: utf-8 -*-
#
# django-migration-docs documentation build configuration file, created by
...
project = u'django-migration-docs'
...
version = migration_docs.__version__
...
htmlhelp_basename = 'django-migration-docsdoc'
...
latex_documents = [
    (
        master_doc,
        'django-migration-docs.tex',
        u'django-migration-docs Documentation',
        u'Opus 10',
        'manual',
    )
]
